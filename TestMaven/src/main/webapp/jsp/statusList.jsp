...
<body>
<b>statuses List</b><br /><br />
<s:form action="statusList" theme="simple"> 

<table><tr><td>select * from Status</td><td><s:textfield name="selectStatement"  size="50" /></td></tr></table>
	<s:actionerror />
	<s:fielderror />
...
<table class="balataOT" border="1" cellpadding="1" cellspacing="0" width="100%">
		...
		<td class="right"><s:property value="#table_stat.index + 1" /></td>
				<td class="center" >
					<s:url id="displayUrl" action="statusListActionDisplay"> 
						<s:param name="index" value = "#table_stat.index" /> 
					</s:url>
					<s:a href="%{displayUrl}" targets="statuses">Display</s:a>
				</td> 
				<td class="center"> 
					<s:url id="editUrl" action="statusListActionEdit"> 
						<s:param name="index" value = "#table_stat.index" /> 
					</s:url>
					<s:a href="%{editUrl}" targets="statuses">Edit</s:a>
				</td> 
				<td class="center"> 
					<s:url id="removeUrl" action="statusListActionRemove"> 
						<s:param name="index" value = "#table_stat.index" /> 
					</s:url>
					<s:a href="%{removeUrl}" targets="statuses">Remove</s:a>
				</td> 
